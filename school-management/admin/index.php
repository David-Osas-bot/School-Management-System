...
// Chart.js only needed on this page
$extraScripts = '
...
<script>
  ...
  new Chart(document.getElementById("attendanceChart"), {
    ...
    data: {
      ...
      datasets: [
        { label:"Present", data:[92,88,95,90,85], backgroundColor:"#2DB596", borderRadius:4, barPercentage:0.5, categoryPercentage:0.6 },
        { label:"Absent",  data:[8,12,5,10,15],   backgroundColor:"#E05252", borderRadius:4, barPercentage:0.5, categoryPercentage:0.6 }
      ]
    },
    options: {
      ...
      scales:{
        ...
        y:{ min:0, max:100, grid:{ color:"rgba(0,0,0,0.06)" }, ticks:{ color:"#9ca3af", stepSize:25 }, border:{ display:false } }
      }
    }
  });
  ...
  new Chart(document.getElementById("gradeChart"), {
    ...
    data: {
      labels: ["A","B","C","D","F"],
      datasets:[{ data:[30,35,20,10,5], backgroundColor:["#22c55e","#2DB596","#f59e0b","#E05252","#6b7280"], borderWidth:2, borderColor:"#fff", hoverOffset:6 }]
    },
    options: {
      ...
      plugins:{
        legend:{
          position:"right",
          labels:{ color:"#374151", font:{ size:13 }, padding:16, usePointStyle:true,
...
<div class="dash-charts">
    ...
    <div class="chart-card">
        ...
        <div class="chart-wrap chart-donut-wrap"><canvas id="gradeChart"></canvas></div>
    </div>
</div>
